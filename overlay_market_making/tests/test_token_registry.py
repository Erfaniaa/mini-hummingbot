...
from mini_hummingbot.core.token_registry import TokenRegistry, TOKENS_DIR, BEP20_MAINNET_FILE
...
def test_token_registry_load_and_get(tmp_path):
    # Prepare tokens dir and sample file
    ...
    # Monkeypatch constants to point to temp dir
    from mini_hummingbot.core import token_registry as tr
